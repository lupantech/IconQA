...
def compute_test_acc(pred_logits, qIds, dataloader):
    ...
    for i, data in enumerate(dataloader.dataset.entries):
        ...
        gt_ans = int(data['answer']) # for multi-choice sub-tasks
...
def parse_args():
    ...
    parser.add_argument('--feat_label', type=str, default='resnet101_pool5_79_icon',
                        help = 'resnet101_pool5: official pretrained model, resnet101_pool5_79_icon: icon pretrained model')
    parser.add_argument('--choice_feat', type=str, default='resnet101_pool5_icon',
                        help = 'resnet101_pool5: official pretrained model, resnet101_pool5_icon: icon pretrained model')

    parser.add_argument('--input', type=str, default='../data')
    parser.add_argument('--model_input', type=str, default='../saved_models/choose_img')
    parser.add_argument('--output', type=str, default='../results/choose_img')
    # model and label
    ...
    parser.add_argument('--max_length', type=int, default=71)
...
if __name__ == '__main__':
    ...
    eval_dset = IconQAFeatureDataset('test', args.task, args.feat_label, args.choice_feat, args.input,
                                  dictionary, args.lang_model, args.max_length, args.num_patches) # generate test data
